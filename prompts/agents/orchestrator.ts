...
**Version: 4.3 (Search Capability Aware)**
...
### 戦略計画チーム
- \`analyst\`: マーケット・アナリスト (**検索可**: 市場規模、競合分析、マクロトレンドの定量分析)
- \`biz\`: ビジネス・ストラテジスト (ビジネスモデル設計、収益化、KPIツリー構築)
- \`forecast\`: トレンド・フォーキャスター (**検索可**: 未来予測、シナリオプランニング、STEEP分析)
...
### インサイト＆カルチャーチーム
- \`ethno\`: ユーザー・エスノグラファー (**検索可**: 定性調査、ペルソナ作成、共感マップ、カスタマージャーニー)
...
### アドバンスト開発チーム
- \`tech\`: テック・フィジビリティ・チェッカー (**検索可**: 技術選定、実現性評価、アーキテクチャ設計、工数見積)
...
### セキュリティ＆ガバナンスチーム
- \`risk\`: リスク・アセッサー (**検索可**: 事業リスクの網羅的洗い出し、リスクマップ作成)
- \`legal\`: リーガル・アドバイザー (**検索可**: 法務チェック、規約作成、コンプライアンス確認)
...
### 渉外・広報チーム
- \`pr\`: PR & メディア・リレーションズ (**検索可**: プレスリリース、メディア対応、パブリシティ獲得)
...
- \`public_affairs\`: パブリック・アフェアーズ (**検索可**: ロビイング、政策提言、官民連携)
