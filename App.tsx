...
const App: React.FC = () => {
  ...
  return (
    <div className={`flex flex-col h-screen text-gray-100 relative transition-colors duration-[2000ms] ease-in-out ${getBackgroundGradient(systemStatus)}`}>
      ...
      <header className="text-center px-4 py-3 border-b border-gray-700 bg-gray-900/30 backdrop-blur-sm sticky top-0 z-10 flex justify-between items-center transition-colors duration-1000">
      ...
      <main className="flex-grow p-2 sm:p-4 grid grid-rows-[255px_1fr] gap-4 min-h-0">
        ...
        <div className="min-h-0 overflow-y-auto p-4 pb-4 -m-2 sm:-m-4 custom-scrollbar">
          {isInitialState ? (
